 ...
 * @fn          HalI2CInit1
 *
* @brief       Initialize the I2C bus as a Master.addr:8bit
 *
 * input parameters
 *
 ...
 * @return      None.
 */
void HalI2CInit1(uint8 address, i2cClock_t clockRate)
{
  i2cAddr = address ;
 ...
 * @fn          HalI2CInit
 *
 * @brief       Initialize the I2C bus as a Master.addr:7bit
 *
 * input parameters
 *
 * @param       address - I2C slave address.
